...
<head>
    ...
    <title>Blogie: Update Post</title>
...
<div id="overlay">
    ...
    <!-- Modal -->
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <div class="modal-body">
                Your post has been successfully updated to the system.<br>
                Your post changes will be live after approval from the admin.<br>
    ...
    $query = "SELECT * FROM users WHERE id = $p_by";
    $row = mysqli_fetch_assoc(mysqli_query($conn,$query));
    ...
    ?>
            ...
            <div class="row">
                    ...
                    <div class="text-right" style="margin-top: 30px; margin-bottom: 30px;">
                            <button type="button" id="update_post_btn" name="update_post" class="btn btn-lg btn-primary" style="padding: 10px 50px; float: left;" >Update Post</button>
                        </div>
                    </div>
