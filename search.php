...
include "db.php";
	if(isset($_GET['search'])){
		...
		$query = "SELECT * FROM posts WHERE (title LIKE '%$search%' OR tags LIKE '%$search%') AND (status = 'Approved')";
...
<head>
	...
	<title>Blogie: Search Results</title>
			...
			<div class="row" style="margin-top: 10px; margin-bottom: 50px;">
				<div class="col-md-12">
                    ...
                    <div class="alert alert-warning text-center">
                        <p class="lead">Sorry, No results found for this keyword :(</p>
                    </div>
